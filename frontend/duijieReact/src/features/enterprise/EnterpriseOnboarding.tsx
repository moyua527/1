  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(135deg, #f0f4ff 0%, #e8f0fe 50%, #f5f3ff 100%)', padding: 20 }}>
      ...
      <div style={{ display: 'flex', gap: 20, flexWrap: 'wrap', justifyContent: 'center' }}>
        <div style={{ width: 260, padding: '32px 24px', background: 'var(--bg-primary)', borderRadius: 16, border: '1px solid var(--border-primary)', textAlign: 'center', boxShadow: '0 4px 24px rgba(0,0,0,0.06)', cursor: 'pointer', transition: 'all 0.2s' }}
          ...
          <div style={{ width: 56, height: 56, borderRadius: 14, background: 'var(--bg-selected)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 16px' }}>
            <Plus size={28} color="var(--brand)" />
          </div>
          <div style={{ fontSize: 18, fontWeight: 700, color: 'var(--text-heading)', marginBottom: 8 }}>创建企业</div>
        ...
        <div style={{ width: 260, padding: '32px 24px', background: 'var(--bg-primary)', borderRadius: 16, border: '1px solid var(--border-primary)', textAlign: 'center', boxShadow: '0 4px 24px rgba(0,0,0,0.06)', cursor: 'pointer', transition: 'all 0.2s' }}
          ...
          <div style={{ width: 56, height: 56, borderRadius: 14, background: '#f0fdf4', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 16px' }}>
            <LogIn size={28} color="var(--color-success)" />
          </div>
          <div style={{ fontSize: 18, fontWeight: 700, color: 'var(--text-heading)', marginBottom: 8 }}>加入企业</div>
          <div style={{ fontSize: 13, color: 'var(--text-tertiary)', lineHeight: 1.6 }}>
            搜索并申请加入<br />已有企业的团队
          </div>
        </div>
