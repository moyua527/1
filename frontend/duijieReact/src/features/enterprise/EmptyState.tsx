...
export default function EmptyState(props: Props) {
  ...
  return (
    <div>
      ...
      <p style={{ fontSize: 14, color: 'var(--text-tertiary)', marginBottom: 20, marginTop: 0 }}>创建并管理您的企业信息</p>
      <div style={{ ...section, textAlign: 'center', padding: '60px 20px' }}>
        ...
        <div style={{ fontSize: 18, fontWeight: 700, color: 'var(--text-heading)', marginBottom: 6 }}>您还没有企业</div>
        <div style={{ fontSize: 14, color: 'var(--text-tertiary)', marginBottom: 24 }}>创建新企业或加入已有企业</div>
