...
interface Props { open: boolean; onClose: () => void; title: string; children: React.ReactNode; width?: number; minHeight?: number }
...
export default function Modal({ open, onClose, title, children, width = 500, minHeight = 500 }: Props) {
  useEffect(() => {
