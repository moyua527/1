            ...
            <div key={f.id} style={{ position: 'relative', paddingBottom: 20 }}>
              ...
              <div style={{ marginLeft: 8 }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginTop: 6 }}>
                  ...
                  <button onClick={() => startEdit(f)} style={{ fontSize: 11, color: '#2563eb', background: 'none', border: 'none', cursor: 'pointer', padding: '2px 6px' }}>编辑</button>
                  <button onClick={() => handleDelete(f.id)} style={{ fontSize: 11, color: '#dc2626', background: 'none', border: 'none', cursor: 'pointer', padding: '2px 6px' }}>删除</button>
                </div>
              </div>
            </div>
          ))}
