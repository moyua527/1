...
interface Props { clientId: string; contacts: any[]; onRefresh: () => void; embedded?: boolean }

export default function ContactSection({ clientId, contacts, onRefresh, embedded }: Props) {
