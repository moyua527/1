...
export const milestoneApi = {
  ...
  addProgress: (id: string, content: string, mentioned_user_ids?: number[]) => fetchApi(`/api/milestones/${id}/progress`, { method: 'POST', body: JSON.stringify({ content, mentioned_user_ids }) }),
