...
export const authApi = {
  ...
  register: (data: { username: string; password: string; nickname?: string; email?: string; phone?: string; gender: number; area_code: string; user_type?: string; province?: string; city?: string; position?: string; invite_code?: string; invite_token?: string }) =>
