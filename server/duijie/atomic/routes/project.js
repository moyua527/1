...
router.get('/projects/:id/task-title-options', auth, pag, projectPermGuard('can_manage_task_preset'), require('../controllers/project/taskTitleOptionsController'));
router.post('/projects/:id/task-title-history', auth, pag, projectPermGuard('can_manage_task_preset'), require('../controllers/project/rememberTaskTitleController'));
router.delete('/projects/:id/task-title-history/:historyId', auth, pag, projectPermGuard('can_manage_task_preset'), require('../controllers/project/deleteTaskTitleHistoryController'));
router.patch('/projects/:id/task-title-presets', auth, pag, projectPermGuard('can_manage_task_preset'), require('../controllers/project/updatePresetsController'));
...
router.put('/projects/:id/members/:memberId', auth, pag, projectPermGuard('can_update_member_role'), require('../controllers/project/updateMemberRoleController'));
...
router.post('/projects/:id/client-members', auth, pag, projectPermGuard('can_manage_client_member'), require('../controllers/project/addClientMemberController'));
router.delete('/projects/:id/client-members/:userId', auth, pag, projectPermGuard('can_manage_client_member'), require('../controllers/project/removeClientMemberController'));
...
router.post('/projects/:id/join-requests/:requestId/reject', auth, pag, projectPermGuard('can_approve_join'), require('../controllers/project/joinRequestReviewController'));
