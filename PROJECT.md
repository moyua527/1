...
### 4.22.1 合作企业资料（Enterprise Profile）
...
│               ├── Avatar.tsx / Badge.tsx / Toast.tsx / ProgressBar.tsx
│               ├── NotificationBell.tsx / CommandPalette.tsx
│               ├── FilterBar.tsx / PageHeader.tsx / Pagination.tsx
│               ├── DataTable.tsx / GanttChart.tsx / StatsCards.tsx
│               ├── Skeleton.tsx / EmptyState.tsx / ErrorBoundary.tsx
│               ├── ImageViewer.tsx / ImageEditor.tsx / ImageUploadPreview.tsx
│               ├── MobilePushBridge.tsx / PullToRefresh.tsx / GestureLockScreen.tsx
│               ├── EnterpriseSwitcher.tsx / ProfileModal.tsx / ThemeToggle.tsx
│               ├── UserGuide.tsx / ProjectGuide.tsx / OnboardingChecklist.tsx
│               ├── AppUpdateChecker.tsx / SwUpdateBanner.tsx / OfflineBanner.tsx
│               ├── BatchActionBar.tsx / SectionCard.tsx / InfoGrid.tsx / SettingsPanel.tsx
│               └── useIsMobile.ts / smartSocket.ts / tokens.ts
│
...
│   ├── package.json
│   ├── atomic/
│   │   ├── routes/index.js            # 路由映射（295 个端点，12 个路由模块）
│   │   ├── middleware/
│   │   │   ├── auth.js                # JWT 认证中间件
│   │   │   ├── roleGuard.js           # 角色权限守卫
...
│   │       ├── ai/                    # AI 建议
│   │       ├── audit/                 # 审计日志
│   │       ├── auth/                  # 认证（login/register/me/profile/sessions/login-logs 等）
│   │       ├── client/                # 客户（CRUD + members + clientRequest + scores）
│   │       ├── contact/               # 联系人
│   │       ├── contract/              # 合同
│   │       ├── customField/           # 自定义字段（项目扩展属性）
│   │       ├── dashboard/             # 仪表盘（stats/report/chart/workspace）
│   │       ├── dm/                    # 站内消息
│   │       ├── enterprise/            # 企业管理（CRUD/join/departments/members/roles）
│   │       ├── file/                  # 文件管理
│   │       ├── followUp/              # 跟进记录
│   │       ├── invite/                # 邀请链接
│   │       ├── knowledgeController.js # 知识库
│   │       ├── message/               # 项目消息
│   │       ├── milestone/             # 里程碑/代办
│   │       ├── notification/          # 通知（list/markRead/delete/cleanup/SSE/device）
│   │       ├── opportunity/           # 商机
│   │       ├── project/               # 项目（CRUD/members/roles/cover/join/invite/stats 等）
│   │       ├── resource/              # 资料组
│   │       ├── search/                # 全局搜索
│   │       ├── system/                # 系统配置 + 应用版本 + bundle
│   │       ├── tag/                   # 标签
│   │       ├── task/                  # 任务（CRUD/move/remind/attachments/review-points/drafts）
│   │       ├── template/              # 项目模板
│   │       ├── ticket/                # 工单
│   │       ├── timesheet/             # 工时汇报
│   │       └── user/                  # 用户管理
...
|------|------|
| 后端控制器模块 | 27 个 |
| API 端点 | 295 个（12 个路由文件） |
| 数据库表 | 57 张 |
| 平台角色 | 2 种（admin / member），具体能力由企业权限 + 项目权限叠加控制 |
| 前端功能模块 | 21 个 |
| 共享 UI 组件 | 45 个（42 .tsx + 3 .ts） |
| 前端路由 | 27 条 |
| 版本迭代 | 100 个（v1.0.0 ~ v1.4.36，详见 CHANGELOG.md） |
