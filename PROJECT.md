...
- **个人资料**：侧边栏点击头像 → 查看个人信息（昵称/邮箱/手机/性别/角色/注册时间/邀请码），点击「编辑资料」按钮进入编辑模式修改昵称/邮箱/手机号/密码；移动端"我的"页点击头像卡片进入微信风格个人资料页，支持头像上传、昵称编辑弹窗、性别选择底部弹窗、手机号脱敏展示，跳转绑定手机/邮箱
