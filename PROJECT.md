...
- **登录暴力破解防护**：登录接口 15 分钟最多 10 次尝试，注册接口 1 小时最多 5 次
- **API 速率限制**：全局每 IP 每 15 分钟最多 300 次请求
- **Helmet 安全响应头**：X-Content-Type-Options、X-Frame-Options、Strict-Transport-Security 等
- **CORS 白名单**：仅允许 localhost:1300、160.202.253.143:8080 等已知来源
